<template>
  <div class="flex items-center justify-center w-full">
    ...
    <div class="w-full shadow-sm mb-8">
      <div class="md:p-8 p-5 dabg-rk:gray-800 bg-white rounded-t">
        <div class="px-4 flex items-center justify-between">
          <span
            tabindex="0"
            class="focus:outline-none text-base font-bold text-gray-700"
            >January 2024</span
          >
          <div class="flex items-center">
            <button
              aria-label="calendar backward"
              class="focus:text-gray-400 hover:text-gray-400 text-gray-700"
            >
              <svg
            ...
            <button
              ...
              class="focus:text-gray-400 hover:text-gray-400 ml-3 text-gray-700"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="md:py-8 py-5 md:px-16 px-5 bg-gray-50 rounded-b">
        <div class="px-4">
          ...
          <div class="border-b pb-4 border-gray-400 border-dashed">
            ...
            <a
              ...
              class="
                ...
                mt-2
              "
              >Individual Therapy Session</a
            >
            <p class="text-sm pt-2 leading-4 leading-none text-gray-600">
              Session with John Doe focusing on cognitive-behavioral therapy
              techniques.
            </p>
          </div>
          ...
          <div class="border-b pb-4 border-gray-400 border-dashed pt-5">
            <p class="text-xs font-light leading-3 text-gray-500">10:30 AM</p>
            <a
              tabindex="0"
              class="
                focus:outline-none
            ...
            >
            <p class="text-sm pt-2 leading-4 leading-none text-gray-600">
              Discussion on new wellness programs and patient outreach
              strategies.
            </p>
          </div>
          ...
          <!-- Appointment 3 -->
          <div class="border-b pb-4 border-gray-400 border-dashed pt-5">
            <p class="text-xs font-light leading-3 text-gray-500">1:00 PM</p>
            <a
              tabindex="0"
              class="
                focus:outline-none
                ...
                mt-2
              "
              >Group Therapy Session</a
            >
            <p class="text-sm pt-2 leading-4 leading-none text-gray-600">
              Facilitating a group session on stress management techniques.
            </p>
          </div>
        </div>
      </div>
...
<script>
  export default {
    ...
    // Methods, computed properties, etc. can be added as needed
  }
</script>
